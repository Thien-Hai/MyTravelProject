...
const DiscountTourPage = () => {
    ...
    useEffect(() => {
        axiosInstance.get('http://localhost:5000/tours/get-all-tours')
            .then(response => {
                setTours(response.data.filter(tour => tour.discountedPrice));
            })
            .catch(error => {
                        ...
                        <div className="row justify-content-center" style={{ marginLeft: '-2.5%' }}>
                            ...
                            <div className='col-9' style={{ marginRight: '-5%' }}>
                                ...
                                <div className="tour-introduce">
                                    <div className="title"> Tour đang giảm giá </div>
                                    <br />
                                </div>
...
export default DiscountTourPage
