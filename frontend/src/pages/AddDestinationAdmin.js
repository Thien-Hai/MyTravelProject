...
const AddDestination = () => {
    ...
    return (
        <div>
            <h4 className="mb-4">Thêm mới điểm đến</h4>
            {notification && (
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="category-wrapper">
                        ...
                        {/* <TextArea
                                  ...
                                  onChange={handleDestinationDescChange}/> */}
                        <QuillEditor onEditorChange={handleDestinationDescChange} />
                    </div>
                    <div className="category-wrapper">
                        <div className="category-header">
                            <h5 className="sub-title"> Vị trí tổng quan </h5>
                        </div>
                        <input type="text"
                            className="brandname-input"
                    ...
                    <div className="category-wrapper">
                        <div className="category-header">
                            <h5 className="sub-title"> Link ảnh </h5>
                        </div>
                        <input type="text"
                            className="brandname-input"
